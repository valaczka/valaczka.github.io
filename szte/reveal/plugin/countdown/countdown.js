...
var RevealCountDown =
  ...
  (function() {
    ...
    function updateTimer(timeLeft) {
      ...
      secondsLeft = (secondsLeft % 60).toString().padStart(2, "0");
      hoursLeft = Math.floor(minutesLeft / 60);
      minutesLeft = (minutesLeft % 60).toString().padStart(2, "0");
      ...
      if (minutesLeft > 0) {
        counterRef.innerHTML = minutesLeft + ":" + secondsLeft;
        return;
      }
      if (minutesLeft <= 0) {
        counterRef.innerHTML = secondsLeft + " mp";
        return;
      }
    }
